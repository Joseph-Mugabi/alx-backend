...
"""
Implements class LFUCache caching system which thrashes out
the least frequently used item from cache_data dict
"""
import datetime
...
class LFUCache(BaseCaching):
    """Implements Least Frequently Used cache"""
    def __init__(self):
        super().__init__()
        self.count = {}
        self.time_stamp = {}
    ...
    def put(self, key, item):
        """Assign item value in cache_data dict"""
        if key and item:
